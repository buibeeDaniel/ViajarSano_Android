...
public class DespuesDeViajar extends Activity {
	...
	public void onCreate(Bundle savedInstanceState)
	{
        ...
        hiloTerminado=false;
        setContentView(R.layout.despues_de_viajar);
        findViews();
        rellenaLista();
		//configBuscador();
	...
	/*	txtProvincia = (TextView)findViewById(R.id.titularprovincia);
	    ...
	    Button btn_press = (Button) findViewById(R.id.menu_proximas);
        btn_press.setBackgroundDrawable(getResources().getDrawable(R.drawable.fondomenu3focused));        
	}
